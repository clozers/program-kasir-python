...
print("--------------------------------------------------------------------------")
nama_op = input("Masukan Nama Operator Warnet : ")
if nama_op == "op1":
    nama = "budi"
elif nama_op == "op2":
    nama = "Dava"
...
if makanan == "y" or makanan =="Y" :
    ...
    print("------------------------------------")
    a = int(input("Banyak menu makanan : "))
    for i in range(a) :
        print("Menu makanan ke",i+1)
        kode_makanan.append(input("Pilih kode Makanan : "))
        banyak_pesan_makanan.append(int(input("Ingin pesan berapa : ")))
...
if minuman == "y" or minuman == "Y" :
    ...
    print("------------------------------------")
    b = int(input("Banyak menu minuman : "))
    for c in range(b) :
        print("Menu minuman ke",c+1)
        kode_minuman.append(input("Pilih kode minuman : "))
        banyak_pesan_minuman.append(int(input("Ingin pesan berapa : ")))
...
print("Alamat    : Jl.kumbang, no.8, Jakarta Selatan, Jakarta")
print("-" * 79)
print("Nama Operator Warnet :", nama)
print("-" * 79)
print("PEMBAYARAN")
print("-" * 79)
